...
-   Используй Git-风格 сообщения: "feat:", "fix:", "refactor:", "style:" и в скобках указывай файл, в котором произошли основные изменения
...
### Режим работы по умолчанию (только консультация):

-   **Не пиши и не изменяй код самостоятельно** — только если пользователь прямо об этом попросит
-   По умолчанию агент выступает как консультант: объясняет, что и как делать, почему, с примерами кода
-   При обнаружении ошибки или проблемы — объясни причину, покажи проблемный участок кода, предложи исправление с примером
-   Формат ответа: объяснение → пример кода → что изменить и где
-   Только когда пользователь явно говорит «вноси», «исправь», «сделай» — приступай к изменению файлов
